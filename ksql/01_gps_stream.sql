-- Phase 4 Step 2 — register Avro gps-events as a ksqlDB stream.
-- Schema comes from Schema Registry subject gps-events-value (Nest producer).
...
CREATE STREAM IF NOT EXISTS gps_events
  WITH (
